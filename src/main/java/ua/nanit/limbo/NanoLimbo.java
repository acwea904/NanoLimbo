...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "59c844ce-220b-4f49-afd4-35da7456c458"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("HY2_PORT", "23009");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("TUIC_PORT", "");          // tuic节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("ANYTLS_PORT", "23009");        // anytls节点(tcp协议)端口，支持多端口可以填写，否则留空
        ...
        envVars.put("CHAT_ID", "-1003361290202");            // telegram chat id,节点推送到telegram使用
        envVars.put("BOT_TOKEN", "8077067543:AAF7eRnk1kZp-nrrRD0OM5_603mUOGPbUGk");          // telegram bot token,节点推送到telegram使用
